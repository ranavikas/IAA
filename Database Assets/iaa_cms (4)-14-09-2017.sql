...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2017 at 07:22 PM
...
(11, 3, 'Fahad', 'a', 'ali', NULL, NULL, 'fsd', 'ME', '6700', NULL, '4353453499', 222, '43242342399', 333, 'madni198@gmail.com', 'fg@gmail.com', '2017-09-12', 0, 2, 2, 12, 'BioMed Tech', 'Doctor', 2, NULL, '', 1, 1, 1, '2');
...
--
-- Dumping data for table `participant_occupations_autosave`
--

INSERT INTO `participant_occupations_autosave` (`participant_id`, `occupation_id`) VALUES
(11, 1);
...
--
-- Dumping data for table `participant_usergroup_autosave`
--

INSERT INTO `participant_usergroup_autosave` (`participant_id`, `usergroup_id`) VALUES
(11, 1);
...
--
ALTER TABLE `logins`
  MODIFY `login_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
...
--
ALTER TABLE `participants_autosave`
  MODIFY `participant_autosave_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
