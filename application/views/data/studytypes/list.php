    	...
    	<div class="row">
		  ...
		  <div class="col-md-10">
			...
			<div class="panel panel-default" id="headings">
				...
				<a class="btn btn-primary btn-sm " style="margin-right:15px; float:right;" onclick="exportStudyTypeTableToCSV('studytype.csv')">Export Study Types</a>
				...
				<!-- START Main Content -->
  				<div class="panel-body">
					...
					<!-- table -->
                    <table class="table table-striped table-bordered" id="studytypetable" name="">
						<thead>
							<tr>
								<th>Study Type</th>
                                                                <th>Edit</th>
