				...
				<nav class="navbar navbar-dark stylish-color">
  				...
  				<div class="panel-body">
					...
					<?php
						...
						echo form_open('data/studytypes/add/'.$this->uri->segment(4).'', $attributes);
					?>
						...
						<fieldset>
                                                                <div class="row">
                                                                    <div class="form-group required control-label col-sm-4">
                                                                      ...
                                                                      <input type="text" class="form-control" id="study_type" name="study_type" value="<?php echo set_value('study_type'); ?>" maxlength="25">
                                                                    </div>
