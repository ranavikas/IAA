				...
				<nav class="navbar navbar-dark stylish-color">
  				...
  				<div class="panel-body">
					...
					<?php
						...
						echo form_open('data/genders/add/'.$this->uri->segment(4).'', $attributes);
					?>
						...
						<fieldset>
                                                                <div class="row">
                                                                    <div class="form-group required control-label col-sm-4">
                                                                      ...
                                                                      <input type="text" class="form-control" id="gender" name="gender" value="<?php echo set_value('gender'); ?>" maxlength="25">
                                                                    </div>
                                                                    <div class="form-group required control-label col-sm-4">
                                                                      <label for="lname">Gender Abbreviation</label>
                                                                      <input type="text" class="form-control" id="gender_abbrv" name="gender_abbrv" value="<?php echo set_value('gender_abbrv'); ?>" maxlength="2">
                                                                    </div>
                                                                </div> 
