    	...
    	<div class="row">
		  ...
		  <div class="col-md-10">
			...
			<div class="panel panel-default" id="headings">
                           <div class="panel-heading"><h3>Product Type</h3></div>
				<nav class="navbar navbar-dark stylish-color">
  				...
  				<div class="panel-body">
					...
					<?php
						//form data
						$attributes = array('class' => '', 'id' => 'addeditproductype' , 'enctype' => 'multipart/form-data');

						//form validation
						echo validation_errors();

						echo form_open('data/productypes/update/'.$this->uri->segment(4).'', $attributes);
					?>
						...
						<fieldset>
							<div class="row">
                                                            <div class="form-group required control-label col-sm-4">
                                                              ...
                                                              <input type="text" class="form-control" id="product_type" name="product_type" value="<?php echo $record[0]['product_type']; ?>" maxlength="25" >
                                                            </div>
							...
							<button type="reset" class="btn btn-primary" onclick="location.href='<?php echo site_url("data/productypes"); ?>'">Cancel</button>			
						</fieldset>
