			...
			<div class="panel panel-default" id="headings">
				...
				<nav class="navbar navbar-dark stylish-color">
  				...
  				<div class="panel-body">
					...
					<?php
						//form data
						$attributes = array('class' => '', 'id' => 'addcondition' , 'enctype' => 'multipart/form-data');

						//form validation
						echo validation_errors();

						echo form_open('data/conditions/add/'.$this->uri->segment(4).'', $attributes);
					?>
						...
						<fieldset>
							<div class="row">
								<div class="form-group required control-label col-sm-4">
									...
									<input type="text" class="form-control" id="medical_condition" name="medical_condition" value="<?php echo set_value('medical_condition'); ?>" >
								</div>
							</div> <br/>
