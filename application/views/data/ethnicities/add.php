			...
			<div class="panel panel-default" id="headings">
				...
				<nav class="navbar navbar-dark stylish-color" style="margin-bottom :0px !important;">
  				...
  				<div class="panel-body">
					...
					<?php
						//form data
						$attributes = array('class' => '', 'id' => 'addethnicity' , 'enctype' => 'multipart/form-data');

						//form validation
						echo validation_errors();

						echo form_open('data/ethnicities/ADD/'.$this->uri->segment(4).'', $attributes);
					?>
						...
						<fieldset>
							<div class="row">
								<div class="form-group required control-label col-sm-4">
									...
									<input type="text" class="form-control" id="ethnicity" name="ethnicity" value="<?php echo set_value('ethnicity'); ?>" >
								</div>
							</div> <br/>
