				...
				<nav class="navbar navbar-dark stylish-color" style="margin-bottom :0px !important;">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
                                                ...
                                                <li class="breadcrumb-item">
                                                    <a href="<?php echo site_url("data/ethnicities"); ?>">
  				...
  				<div class="panel-body">
					...
					<?php
						//form data
						$attributes = array('class' => '', 'id' => 'addeditethnicity' , 'enctype' => 'multipart/form-data');

						//form validation
						echo validation_errors();

						echo form_open('data/ethnicities/update/'.$this->uri->segment(4).'', $attributes);
					?>
						...
						<fieldset>
							<div class="row">
								<div class="form-group required control-label col-sm-4">
									<label for="ethnicity">Ethnicity</label>
                                                                        ...
                                                                        <input type="text" class="form-control" id="ethnicity" name="ethnicity" value="<?php echo $details[0]['ethnicity']; ?>" maxlength="25" >
								</div>
							</div> <br/>
							...
							<button type="reset" class="btn btn-primary" onclick="location.href='<?php echo site_url("data/ethnicities"); ?>'">Cancel</button>			
						</fieldset>
