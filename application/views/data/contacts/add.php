				...
				<nav class="navbar navbar-dark stylish-color">
  				...
  				<div class="panel-body">
					...
					<?php
						...
						echo form_open('data/contacts/add/'.$this->uri->segment(4).'', $attributes);
					?>
						...
						<fieldset>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group  control-label col-sm-4">
                                                                      ...
                                                                      <input type="text" class="form-control" id="organization" name="organization" value="<?php echo set_value('organization'); ?>" >
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-sm-4">
                                                                      ...
                                                                      <input type="text" class="form-control" id="email" name="alt_email" value="<?php echo set_value('alt_email'); ?>" >
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-sm-1">
                                                                      ...
                                                                      <input type="text" class="form-control" id="phone_ext" name="phone_ext" value="<?php echo set_value('phone_ext'); ?>" maxlength="3">
                                                                    </div>
                                                                    <div class="form-group col-sm-3">
                                                                      <label for="pass">Alternate Phone</label>
                                                                      <input type="text" class="form-control" id="alt_phone" name="alt_phone" value="<?php echo set_value('alt_phone'); ?>" >
                                                                    </div>
                                                                    <div class="form-group col-sm-1">
                                                                      <label for="cpass">Ext</label>
                                                                      <input type="text" class="form-control" id="alt_phone_ext" name="alt_phone_ext" value="<?php echo set_value('alt_phone_ext'); ?>" maxlength="3" >
                                                                    </div>
                                                                </div>
