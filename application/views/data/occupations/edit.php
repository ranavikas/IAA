			...
			<div class="panel panel-default" id="headings">
				...
				<nav class="navbar navbar-dark stylish-color">
  				...
  				<div class="panel-body">
					...
					<?php
						//form data
						$attributes = array('class' => '', 'id' => 'edit_occupation' , 'enctype' => 'multipart/form-data');

						//form validation
						echo validation_errors();

						echo form_open('data/occupations/update/'.$this->uri->segment(4).'', $attributes);
					?>
						...
						<fieldset>
							<div class="row">
								<div class="form-group required control-label col-sm-4">
									...
									<input type="text" class="form-control" id="occupation" name="occupation" value="<?php echo set_value('occupation', $details[0]['occupation']); ?>" >
								</div>
							</div> <br/>
							...
							<button type="reset" class="btn btn-primary" onclick="location.href='<?php echo site_url("data/occupations"); ?>'">Cancel</button>			
						</fieldset>
