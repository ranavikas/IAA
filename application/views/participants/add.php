  				...
  				<div class="panel-body">
					...
					<!-- Flash Message -->
                        ...
                        <?php
                          ...
                          echo form_open('participants/add', $attributes);
                          ?>
                               ...
                               <legend class="scheduler-border">Demographics</legend>
                                  <div class="panel-body">
                                       ...
                                       <div class="form-group">
                                         <label for="firstname" class="col-sm-2 control-label form-groupp required " aria-required="true">First Name</label>
                                         <div class="col-sm-10">
                                       ...
                                       <div class="form-group">
                                         <label for="lastname" class="col-sm-2 control-label form-groupp required" aria-required="true">Last Name</label>
                                         <div class="col-sm-10">
...
<script type="text/javascript">
    ...
    $(function () {
            $.post("<?php echo site_url('participants/autosave'); ?>", function (data) {
                $("[name='fname']").val(data.fname);
                $("[name='lname']").val(data.lname);
                $("[name='userfile']").val(data.userfile);
            }, "json");
            setInterval(function () {
                $.post("<?php echo site_url('participants/autosave'); ?>", $("form").serialize());
            }, 10000);
        });
