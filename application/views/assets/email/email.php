					...
					<td >
						<a href="" style="text-decoration:none;">
							<div style="" class="mws-form-row">
								<span style="font-size:34px;color:rgba(21, 100, 176, 0.9);font-weight:bold;">Owebest</span>
							</div>
						</a>
						<map name="Map" id="Map">
					...
					<table width="500" align="center" style="padding:15px 0;" cellpadding="0" cellspacing="0" border="0" border-spacing="0" style="border:none; border-spacing:0">
						<tr>
							<td width="19%" valign="middle" style=" border-spacing:0">
								<a href="#" style="color:#000;font-family: 'Conv_Tahoma Regular';display:inline-block; font-size:12px;text-decoration:none; vertical-align:top">{{ trans("Terms of Use") }}</a> 
								<!--
							...
							<td width="40%" valign="top" style=" border-spacing:0; text-align:right">
								<p style="color:#000;font-family: 'Conv_Tahoma Regular'; font-size:12px; margin:0">yhasdaghd</p>
							</td>
						</tr>
					</table>
				</tr>
