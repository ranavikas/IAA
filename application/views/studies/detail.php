			...
			<div class="panel panel-default" id="headings">
  				...
  				<div class="panel-body">
                          ...
                          <?php
                                    ...
                                    echo form_open('studies/update/'.$study_id.'', $attributes);
                            ?>               
                                          ...
                                          <div class="input_fields_wrap"> 
                                               ...
                                               if (!empty($user_groups)) { 
                                                 ...
                                                 for($i = 0; $i<count($user_groups) ; $i++) { 
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group ugroupp" id="usergroupp<?php echo $user_groups[$i]['id']; ?>">
                                                                <label for="focus_vision" class="col-sm-2 control-label">User Group <?php echo $j; ?></label>
                                                                <div class="col-sm-2" style="width:150px;">
                                                                <input type="hidden" name="user_group_id[]" id="user_group_id_<?php echo $j; ?>" value="<?php echo $user_groups[$i]['id']; ?>">     
                                                                ...
                                                                <div class="col-sm-1">
                                                                    ...
                                                                    <input type="text" class="form-control" id="payment_amount" name="payment_amount[]" value="<?php echo $user_groups[$i]['payment_amount'];?>" style="width: 50px;" >                                                               
                                                               </div>
                                                                 
                                                                <div class="col-sm-2" style="width:150px;"> 
                                                                   <select name="training[]" id="status" class="form-control">
                                                                       <option value="1" <?php if($user_groups[$i]['training'] == '1'){?> selected<?php } ?>>Trained</option>
                                                                ...
                                                                <select name="session_order[]" id="session_order" class="form-control session_orders">
                                                                    <option value="1_<?php echo $j;?>" <?php if($user_groups[$i]['number_of_sessions'].'_'.$j== '1_'.$j){?> selected<?php } ?>>1 Session</option>
                                                                        <option value="2_<?php echo $j;?>" <?php if($user_groups[$i]['number_of_sessions'].'_'.$j == '2_'.$j){?> selected<?php } ?>>2 Sessions</option>
                                                                            <option value="3_<?php echo $j;?>" <?php if($user_groups[$i]['number_of_sessions'].'_'.$j == '3_'.$j){?> selected<?php } ?>>3 Sessions</option>
                                                                             <option value="4_<?php echo $j;?>" <?php if($user_groups[$i]['number_of_sessions'].'_'.$j == '4_'.$j){?> selected<?php } ?>>4 Sessions</option>
                                                                  </select>
                                                                 </div>
                                                                 ...
                                                                 <a class="delete_class_old" data-id="<?php echo $user_groups[$i]['id']; ?>" ><span class="fa fa-remove"></span></a>
                                                            </div>
                                                    </div> 
                                              ...
                                              <?php  $j++; } 
                                               ...
                                               <div class="row">
                                                   <div class="form-group ugroupp" id="usergroupp1">
                                                                ...
                                                                <div class="col-sm-1">
                                                                    <span style="float: left; margin-right: 5px; margin-top: 7px;">$</span>
                                                                    <input type="text" class="form-control" id="payment_amount" name="payment_amount[]" placeholder="0" value="" style="width: 50px;" >                                                               
                                                               </div>
                                                                ...
                                                                <select name="session_order[]" id="session_order" class="form-control session_orders">
                                                                       <option value="1_1">1 Session</option>
                                                                        <option value="2_1" >2 Session2</option>
                                                                            <option value="3_1">3 Session2</option>
                                                                             <option value="4_1">4 Session2</option>
                                                                  </select>
                                                                 </div>
                         ...
                         <div class="form-group">
                            <div class="col-sm-offset-5 col-sm-12">
                               <button type="submit" name="savebtn" value="0" class="btn btn-primary btn-space">Update Details</button>
...
<script type="text/javascript">
   ...
   $(function () {
        setInterval(function () {
            $.post('<?php echo site_url('studies/update_autosave/'.$study_id); ?>', $('#addeditstudy').serialize(), function (data) {
 ...
 $(document).on('click',  '.delete_class_old', function(){
	...
	if ( sure ) {
		...
		$.post('<?php echo site_url('studies/user_group_delete/'); ?>', {groupId:group_id}, function(){ 
