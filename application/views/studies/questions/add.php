  				...
  				<div class="panel-body">
					...
					<!-- Flash Message -->
                        ...
                        <?php
                          ...
                          echo form_open('questions/add', $attributes);
                          ?>
                            <div class="col-md-12"> 
                                  <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-10">
                               ...
                               <button type="submit" name="savebtn" value="0" class="btn btn-primary btn-space">Save</button>
                               <button type="submit" name="savebtn" value="1" class="btn btn-primary">Save & Add an other Question</button>
