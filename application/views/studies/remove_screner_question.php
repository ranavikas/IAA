    	...
    	<div class="row">
		  ...
		  <div class="col-md-10">
			...
			<div class="panel panel-default" id="headings">
                            ...
                            <div class="panel-heading"><h3>Select Screener Questions for Remove</h3></div>
				...
				<!-- START Main Content -->
                        <div class="panel-body">
                         ...
                         <?php
                          //form data
                          $attributes = array('class' => 'form-horizontal', 'id' => 'removequestions' , 'enctype' => 'multipart/form-data');

                          //form validation
                          echo validation_errors();

                          echo form_open('studies/remove_screener_questions', $attributes);
                          ?>
                        ...
                        <table class="table table-striped table-bordered dataTable" id="example" name="study">
                         ...
                         <div class="form-group">
                            <div class="col-sm-offset-1 col-sm-12">
                                ...
                                <button type="submit" name="savebtn"  value="<?php echo $onegroup;?>" class="btn btn-primary">Remove selected question from <?php echo $group_name['0'];?> User group</button>
