    	...
    	<div class="row">
		  ...
		  <div class="col-md-10">
			...
			<div class="panel panel-default" id="headings">
                            ...
                            <div class="panel-heading"><h3>Update user group</h3></div>
				...
				<!-- START Main Content -->
					...
					<!-- table -->
                         ...
                         <?php
                          ...
                          echo form_open('studies/change_user_group', $attributes);
                          ?>
                        ...
                        <table class="table table-striped table-bordered" name="study">
                            <thead>
                                    <tr>
                                            <th>User Group</th>
                                    </tr>
