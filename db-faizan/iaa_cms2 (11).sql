...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2017 at 07:26 PM
...
(1, 2, '', '', '', '', '', '', '', '', NULL, '', 0, '', 0, '', '', '0000-00-00', 0, 1, 1, -1, '1', '', 1, NULL, '', NULL, NULL, NULL, '');
...
(2, 2, 3, 1, 1, 3, '2017-08-24', '2017-08-27', 1, 0, 4, 3, 6, 4, '2', ' study notes text area', 'DNQ textare', '	\r\nName Azeeem11 khan11Email madni38011@yahoo.comPhone 435345349911Organization dsdsd11');
...
--
ALTER TABLE `logins`
  MODIFY `login_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
