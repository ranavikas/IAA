...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2017 at 07:30 PM
...
(3, 2, 0, 1, 1, 1, 3, '0000-00-00', '0000-00-00', 1, 0, 3, 3, 3, 3, '3', '', '', '');
...
--
ALTER TABLE `logins`
  MODIFY `login_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `participants_autosave`
  MODIFY `participant_autosave_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
